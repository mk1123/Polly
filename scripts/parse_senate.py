...
with open('../data/{}/candidates.txt'.format('senate'), 'w') as save_file:
    for state in states:
        try:
            with open('../data/{}/{}_{}.txt'.format('senate', 'Senate', state), 'r') as load_file:
...
with open('../data/{}/candidates.txt'.format('senate'), 'r') as load_file:
    lines = set()
    with open('../data/{}/ucandidates.txt'.format('senate'), 'w') as save_file:
